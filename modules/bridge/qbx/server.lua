...
function server.removeFrameworkAccountMoney(inv, currency, amount)
	...
	return player.Functions.RemoveMoney('bank', amount, 'ox_inventory-shop')
end
...
function server.syncInventory(inv)
    ...
    -- Same as ESX: avoid zeroing bank when it is listed in inventory:accounts but not stored as items.
    if accounts.bank ~= nil then
        accounts.bank = player.PlayerData.money.bank
    end
