...
type Props = { hideWhenInventoryOpen?: boolean };

const InventoryHotbar: React.FC<Props> = ({ hideWhenInventoryOpen }) => {
  ...
  return (
    <div
      className={`hotbar-wrapper ${hotbarVisible ? 'hotbar-visible' : ''} ${
        hideWhenInventoryOpen ? 'hotbar-wrapper--inventory-open' : ''
      }`}
    >
