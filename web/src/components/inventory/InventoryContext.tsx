  ...
  const handleClick = (data: DataProps) => {
    ...
    switch (data && data.action) {
      ...
      case 'give':
        ...
        break;
      case 'giveNearby': {
        const { itemAmount, leftInventory } = store.getState().inventory;
        ...
        fetchNui('giveItemNearby', { slot: item.slot, count });
        break;
      }
      case 'drop':
  ...
  return (
    <>
      <Menu>
        ...
        <MenuItem
          onClick={() => handleClick({ action: 'giveNearby' })}
          label={Locale.ui_give_nearby || 'Give to Nearby Player'}
        />
